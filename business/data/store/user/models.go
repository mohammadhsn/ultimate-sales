...
type User struct {
	...
	Rules        pq.StringArray `db:"roles" json:"roles"`
...
//  changed. it uses pointer field. So we can differentiate between a field that
// was not provided and a field that was provided explicitly between a field that
